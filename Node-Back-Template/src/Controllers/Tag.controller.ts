...
export class TagController {
    ...
    public getRouter() {
        ...
        this.router.put(`${this.prefixPath}/:tagId`, (request: Request, response: Response) => this.update(request, response));
        this.router.delete(`${this.prefixPath}/:tagId`, (request: Request, response: Response) => this.delete(request, response));
