...
export class ReportController {
    ...
    public getRouter() {
        this.router.get(`${this.prefixPath}`, (request: Request, response: Response) => this.getAllOpen(request, response));
        this.router.post(`${this.prefixPath}`, (request: Request, response: Response) => this.create(request, response));
        this.router.get(`${this.prefixPath}/professor/:professorId`, (request: Request, response: Response) => this.getByAuthor(request, response));
        this.router.get(`${this.prefixPath}/reviewer/:professorId`, (request: Request, response: Response) => this.getByReviewer(request, response));
        this.router.get(`${this.prefixPath}/:reportId`, (request: Request, response: Response) => this.getById(request, response));
        this.router.delete(`${this.prefixPath}/:reportId`, (request: Request, response: Response) => this.delete(request, response));
        this.router.put(`${this.prefixPath}/:reportId`, (request: Request, response: Response) => this.update(request, response));
