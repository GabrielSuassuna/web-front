...
export class ProfessorController {
    ...
    public getRouter() {
        ...
        this.router.put(`${this.prefixPath}/:professorId`, (request: Request, response: Response) => this.update(request, response));
        this.router.delete(`${this.prefixPath}/:professorId`, (request: Request, response: Response) => this.delete(request, response));
