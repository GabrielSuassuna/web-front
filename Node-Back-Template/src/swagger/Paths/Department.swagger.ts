export const DepartmentPaths = {
    ...
    "/department/{departmentId}/getCoordinator": {
        "get": {
            "tags": ["Department"],
            "summary": "Obtém o coordenador de curso do departamento.",
            "parameters": [
                {
                    "name": "departmentId",
                    "in": "path",
            ...
            "responses": {
                "200": {
                    "description": "OK - Coordenador de curso do departamento obtido com sucesso",
                    "content": {
                        "application/json": {
                            "required": ["data", "message"],
                            "schema": {
                                ...
                                "example": {
                                    ...
                                    "message" : "Coordenador de curso do departamento obtido com sucesso"
                                }, 
                                "properties": {
                                    "data": {
                                        "type": "array",
                ...
                "404": {
                    "description": "Not found - Coordenador de curso do departamento não encontrado",
                    "content": {
                        "application/json": {
                            "required": ["data", "message"],
                            "schema": {
                                ...
                                "example": {
                                    "data": [],
                                    "message" : "Coordenador de curso do departamento não encontrado"
                                }, 
                                "properties": {
                                    "data": {
                                        "type": "array",
                ...
                "400": {
                    "description": "Bad request - Erro ao obter coordenador de curso do departamento",
                    "content": {
                        "application/json": {
                            "required": ["data", "message"],
                            "schema": {
                                ...
                                "example": {
                                    "data": [],
                                    "message" : "Erro ao obter coordenador de curso do departamento"
                                }, 
                                "properties": {
                                    "data": {
                                        "type": "array",
    ...
    "/department/{departmentId}/getDepartmentChief": {
        "get": {
            "tags": ["Department"],
            "summary": "Obtém o chefe do departamento.",
            "parameters": [
                {
                    "name": "departmentId",
                    "in": "path",
            ...
            "responses": {
                "200": {
                    "description": "OK - Chefe de departamento obtido com sucesso",
                    "content": {
                        "application/json": {
                            "required": ["data", "message"],
                            "schema": {
                                ...
                                "example": {
                                    ...
                                    "message" : "Chefe de departamento obtido com sucesso"
                                }, 
                                "properties": {
                                    "data": {
                                        "type": "array",
                ...
                "400": {
                    "description": "Bad request - Erro ao obter chefe de departamento",
                    "content": {
                        "application/json": {
                            "required": ["data", "message"],
                            "schema": {
                                ...
                                "example": {
                                    "data": [],
                                    "message" : "Erro ao obter chefe de departamento"
                                }, 
                                "properties": {
                                    "data": {
                                        "type": "array",
